    ...
    <>
      <NextUIProvider>
        <main className="w-screen h-screen flex justify-center items-center lg:bg-[#9377ef2b]">
          <div className="w-full flex justify-center xs:w-96 sm:shadow py-10 rounded-2xl lg:hidden">
            <FormLogin />
          </div>
          <div className="hidden lg:flex w-[900px] h-5/6 shadow-2xl rounded-2xl bg-white">
